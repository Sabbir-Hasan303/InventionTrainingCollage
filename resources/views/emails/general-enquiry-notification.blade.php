...
<head>
    ...
    <title>Website Enquiry Submission</title>
</head>
        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:680px; background:#ffffff; border:1px solid #e5e7eb; border-radius:14px; overflow:hidden;">
                    <tr>
                        <td style="padding:20px 24px; background:linear-gradient(135deg,#111827 0%,#1f2937 100%);">
                            <p style="margin:0 0 6px 0; font-size:11px; letter-spacing:0.14em; text-transform:uppercase; color:#fcd34d; font-weight:700;">
                                Invention Training College
                            </p>
                            <h1 style="margin:0; font-size:22px; line-height:1.25; color:#ffffff; font-weight:700;">
                                New Website Enquiry Submission
                            </h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:20px 24px 10px 24px;">
                            <p style="margin:0; font-size:14px; line-height:1.6; color:#374151;">
                                A user submitted the website enquiry form. The details are provided below for follow-up.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:10px 24px 0 24px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb; border-radius:10px; overflow:hidden;">
                                <tr>
                                    <td style="width:210px; padding:10px 12px; font-size:13px; font-weight:700; color:#111827; background:#f9fafb; border-bottom:1px solid #e5e7eb;">First Name</td>
                                    <td style="padding:10px 12px; font-size:13px; color:#1f2937; border-bottom:1px solid #e5e7eb;">{{ $payload['first_name'] }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 12px; font-size:13px; font-weight:700; color:#111827; background:#f9fafb; border-bottom:1px solid #e5e7eb;">Last Name</td>
                                    <td style="padding:10px 12px; font-size:13px; color:#1f2937; border-bottom:1px solid #e5e7eb;">{{ $payload['last_name'] }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding:10px 12px; font-size:13px; font-weight:700; color:#111827; background:#f9fafb;">Course</td>
                                    <td style="padding:10px 12px; font-size:13px; color:#1f2937;">{{ $payload['course_code'] ?: 'Not selected' }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:16px 24px 0 24px;">
                            ...
                            <div style="border:1px solid #e5e7eb; border-radius:10px; background:#f9fafb; padding:12px; font-size:13px; line-height:1.7; color:#1f2937;">
                                {!! nl2br(e($payload['message'] ?: 'No message provided')) !!}
                            </div>
                        </td>
                    </tr>
