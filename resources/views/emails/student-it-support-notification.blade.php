...
<head>
    ...
    <title>Student IT Support Request</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:680px; background:#ffffff; border:1px solid #e5e7eb; border-radius:14px; overflow:hidden;">
                    <tr>
                        <td style="padding:20px 24px; background:linear-gradient(135deg,#0f172a 0%,#1e293b 100%);">
                            <p style="margin:0 0 6px 0; font-size:11px; letter-spacing:0.14em; text-transform:uppercase; color:#93c5fd; font-weight:700;">
                                Student Services
                            </p>
                            <h1 style="margin:0; font-size:22px; line-height:1.25; color:#ffffff; font-weight:700;">
                                New Student IT Support Request
                            </h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:20px 24px 10px 24px;">
                            <p style="margin:0; font-size:14px; line-height:1.6; color:#374151;">
                                A student has submitted the IT support form. Please review and follow up promptly.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:10px 24px 0 24px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb; border-radius:10px; overflow:hidden;">
                                ...
                                <tr>
                                    <td style="padding:10px 12px; font-size:13px; font-weight:700; color:#111827; background:#f9fafb; border-bottom:1px solid #e5e7eb;">Student ID</td>
                                    <td style="padding:10px 12px; font-size:13px; color:#1f2937; border-bottom:1px solid #e5e7eb;">{{ $payload['studentId'] }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 12px; font-size:13px; font-weight:700; color:#111827; background:#f9fafb;">Support Option</td>
                                    <td style="padding:10px 12px; font-size:13px; color:#1f2937;">{{ ucfirst(str_replace('-', ' ', $payload['supportOption'])) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
